...
class Builder {
    ...
    buildImageLambda(buildManifest) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return Promise.all([
                this.processAndCopyHandler("image-handler", path_1.join(this.outputDir, exports.IMAGE_LAMBDA_CODE_DIR, "index.js"), !!this.buildOptions.minifyHandlers),
    ...
    buildStaticAssets(defaultBuildManifest, routesManifest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prerenderManifestHTMLPageAssets = Object.keys(prerenderManifest.routes).map((key) => {
                ...
                const destination = path_2.default.join(assetOutputDirectory, withBasePath(path_2.default.join("static-pages", buildId, relativePageFilePath)));
                return copyIfExists(source, destination);
            });
            const fallbackHTMLPageAssets = Object.values(prerenderManifest.dynamicRoutes || {})
                ...
                const destination = path_2.default.join(assetOutputDirectory, withBasePath(path_2.default.join("static-pages", buildId, fallback)));
                return copyIfExists(source, destination);
            });
    ...
    build(debugMode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { defaultBuildManifest, apiBuildManifest, imageBuildManifest } = yield this.prepareBuildManifests();
            ...
            const hasImageOptimizer = fs_extra_1.default.existsSync(path_1.join(this.dotNextDir, "images-manifest.json"));
