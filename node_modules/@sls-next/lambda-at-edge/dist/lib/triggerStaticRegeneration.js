...
const triggerStaticRegeneration = async (options) => {
    ...
    const bucketName = s3BucketNameFromEventRequest_1.s3BucketNameFromEventRequest(options.request);
    if (!bucketName) {
    ...
    const sqs = new SQSClient({
        region,
        maxAttempts: 1,
        retryStrategy: await s3RetryStrategy_1.buildS3RetryStrategy()
    });
